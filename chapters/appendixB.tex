...
\cmidrule(lr){1-3}
GPT   & Generative Pre-Trained Transformer & A family of LLMs based on the Transformer architecture.\\
\cmidrule(lr){1-3}
...
\cmidrule(lr){1-3}
intfloat & intfloat/e5 & A specific implementation of the E5 model, optimised for generating embeddings for information retrieval tasks. \\
\cmidrule(lr){1-3}
