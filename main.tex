...
\midrule
AI & artificial intelligence\\[0.2em]
DH & digital humanities\\[0.2em]
QA & question-answering\\[0.2em]
QAS & question-answering system\\[0.2em]
RAG & retrieval-augmented generation\\[0.2em]
LLM & large language model\\[0.2em]
IR & information retrieval\\[0.2em]
KB & knowledge base\\[0.2em]
NLP & natural language processing\\[0.2em]
ML & machine learning\\[0.2em]
TF-IDF & term frequency-inverse document frequency\\[0.2em]
BM25 & best match 25\\[0.2em]
TREC & Text REtrieval Conference\\[0.2em]
RNN & recurrent neural network\\[0.2em]
LSTM & long short-term memory\\[0.2em]
CRF & conditional random field\\[0.2em]
SVM & support vector machine\\[0.2em]
\bottomrule
\end{tabular}
