...
\hypersetup{
    pdftitle={From Documents to Dialogue: A Question-Answering System for Geoportale Nazionale Archeologia with Retrieval-Augmented Generation},
    pdfauthor={Lucrezia Pograri},
    pdfsubject={MA dissertation in Machine Learning for the Arts and Humanities},
    pdfkeywords={digital humanities, information retrieval, question-answering systems, retrieval-augmented generation, humanistic ai, cultural heritage}
}
\usepackage{listings}
\usepackage{tikz}
...
\thispagestyle{empty}
\mbox{}
{\let\cleardoublepage\clearpage \mainmatter}
\pagestyle{fancy}       
...
% --- make the next chapter NOT start a new page ---
\begingroup
  \makeatletter
  ...
  \input{chapters/QAS}  % this chapter will follow immediately

  \makeatletter
  \let\clearpage\origclearpage
  \let\cleardoublepage\origdoublepage
  \makeatother
\endgroup
% --- normal behaviour resumes for subsequent chapters ---
\input{chapters/SOTA}
